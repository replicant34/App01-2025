...
$query = "
    ...
    FROM Agents a
    LEFT JOIN (
        SELECT Agent_id, Contract_number, Contract_date, Contract_type
    ...
    LEFT JOIN list_contract_type t ON ac.Contract_type = t.Type_id
...
// Get total number of agents for pagination (without the contract details)
$totalStmt = $pdo->query("SELECT COUNT(*) FROM Agents");
$totalAgents = $totalStmt->fetchColumn();
...
<body>
                    ...
                    <table class="mc-clients-table">
                        ...
                        <tbody>
                            <?php foreach ($agents as $agent): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($agent['Company_type']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Full_Company_name']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Short_Company_name']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contract_type'] ?? '-'); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contract_number'] ?? '-'); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contract_date'] ? date('Y-m-d', strtotime($agent['Contract_date'])) : '-'); ?></td>
                                    <td><?php echo htmlspecialchars($agent['INN']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['KPP']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['OGRN']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Physical_address']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Legal_address']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Bank_name']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['BIK']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Settlement_account']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Correspondent_account']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contact_person']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contact_person_position']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contact_person_phone']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Contact_person_email']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Head_position']); ?></td>
                                    <td><?php echo htmlspecialchars($agent['Head_name']); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="dropbtn"><i class="fas fa-ellipsis-v"></i></button>
                                            <div class="dropdown-content">
                                                <a href="#" class="edit" data-id="<?php echo $agent['Agent_id']; ?>">Edit</a>
                                                <a href="#" class="delete" data-id="<?php echo $agent['Agent_id']; ?>">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
    ...
    <script src="js/manage_agents.js"></script>
