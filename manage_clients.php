...
$stmt = $pdo->prepare("SELECT * FROM Clients LIMIT :limit OFFSET :offset");
                    ...
                    <table class="mc-clients-table">
                        ...
                        <tbody>
                            <?php foreach ($clients as $client): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($client['Company_type']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Full_Company_name']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Short_Company_name']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contract_type']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contract_number']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contract_date']); ?></td>
                                    <td><?php echo htmlspecialchars($client['INN']); ?></td>
                                    <td><?php echo htmlspecialchars($client['KPP']); ?></td>
                                    <td><?php echo htmlspecialchars($client['OGRN']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Physical_address']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Legal_address']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Bank_name']); ?></td>
                                    <td><?php echo htmlspecialchars($client['BIK']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Settlement_account']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Correspondent_account']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contact_person']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contact_person_position']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contact_person_phone']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Contact_person_email']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Head_position']); ?></td>
                                    <td><?php echo htmlspecialchars($client['Head_name']); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="dropbtn"><i class="fas fa-ellipsis-v"></i></button>
                                            <div class="dropdown-content">
                                                <a href="#" class="edit" data-id="<?php echo $client['Client_id']; ?>">Edit</a>
                                                <a href="#" class="delete" data-id="<?php echo $client['Client_id']; ?>">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
